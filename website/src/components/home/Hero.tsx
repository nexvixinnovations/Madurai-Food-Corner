...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[82vh] lg:min-h-[88vh] bg-[#0c0503] text-white overflow-hidden flex items-center">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-16 lg:py-24">
        <div className="max-w-2xl flex flex-col items-start text-left space-y-6">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-extrabold leading-[1.1] tracking-tight"
            style={{
